...
import { inject, createDynamicRef, Application, withMemo, InjectionToken, withAnnotation, reactive, shallowReactive } from '@viewfly/core'
...
describe('防止意外的优化', () => {
  ...
  test('确保当前组件未变更时，子组件可以正常变更', () => {
    ...
    const model = shallowReactive({ value: 0 })
